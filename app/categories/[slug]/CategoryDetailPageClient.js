...
export default function CategoryDetailPageClient({ category, initialArticles }) {
  const { data, error, isLoading } = useSWR(
    API_ENDPOINTS.articles.getByCategory(category.id, 20),
    fetcher,
  ...
  if (error) return <div className="text-center py-12 text-red-500">خطا در دریافت اخبار دسته‌بندی</div>;
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-white rounded-lg shadow-md p-8 mb-8">
          <div className="flex items-start justify-between">
            ...
            <div className="flex items-center gap-2">
              <Link href="/categories" className="inline-flex items-center px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500" prefetch={true}>
